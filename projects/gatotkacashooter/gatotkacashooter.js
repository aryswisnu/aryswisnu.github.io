window.addEventListener("DOMContentLoaded", function() {
    ...
    Torpedo.img.src = "images/bolt.png";
    ...
    function Enemy1() {
        ...
        this.explode = function() {
            _explode.call(this);
            if (Math.floor(Math.random() / HeartDrop.CHANCE) == 0)
                new HeartDrop(this);
        };
    }
    ...
    EnemyUFO.img.src = "images/enemy1.png";
    ...
    function generateEnemies() {
        if (gameScore.points >= 500 && gameScore.points < 800) {
        ...
        } else if (gameScore.points >= 2200 && gameScore.points < 3000) {
            if (spriteList.filter(function(sprite) {
                return "isEnemy" in sprite;
            }).length == 0)
            {
                if (!Boss2.spawned)
                {
                    new Boss2(c.width / 2 - Boss2.WIDTH / 2, Boss2.SPEED, 150);
                }
            }
        } else if (Boss2.spawned == true) {
                window.removeEventListener("keydown", pauseHandler, false);
    ...
    function showChar() {
        document.getElementById("start").style.visibility = "hidden";
        document.getElementById("chara").style.visibility = "visible";
        window.removeEventListener("keydown", startHandler, false);
        window.addEventListener("keydown", charaHandler, false);
    }
    
    function returnToStartCredits() {
    ...
    function returnToStartChara() {
        document.getElementById("chara").style.visibility = "hidden";
        document.getElementById("start").style.visibility = "visible";
        window.removeEventListener("keydown", charaHandler, false);
        window.addEventListener("keydown", startHandler, false);
    }
    
    document.getElementById("credits_link").addEventListener("click", showCredits, false);
    document.getElementById("chara_link").addEventListener("click", showChar, false);
